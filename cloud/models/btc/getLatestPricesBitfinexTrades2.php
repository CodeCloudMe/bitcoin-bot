<?php
	...
	function getPrices(){
			...
			dbQuery("INSERT INTO bitfinexPrices (price, bid, ask, volume) VALUES ($price, $bid, $ask, $volume)");
			
		echo("INSERT INTO bitfinexPrices (price, bid, ask, volume) VALUES ($price, $bid, $ask, $volume");
